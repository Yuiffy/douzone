...
<script>(function(){window.onerror=function(f,b,a){var e=location.protocol=="https:"?"https://ssl.qq.com/ptlogin/cgi-bin/ptlogin_report?":"http://log.wtlogin.qq.com/cgi-bin/ptlogin_report?";var c=document.createElement("img");var d=encodeURIComponent(f+"|_|"+b+"|_|"+a+"|_|"+window.navigator.userAgent);c.src=e+"id=195279&msg="+d+"&v="+Math.random()}})();var g_cdn_js_fail=false;var pt={};pt.str={no_uin:"您还没有输入帐号！",no_pwd:"您还没有输入密码！",no_vcode:"您还没有输入验证码！",inv_uin:"请输入正确的QQ帐号！",inv_vcode:"请输入完整的验证码！",qlogin_expire:"您所选择号码对应的QQ已经失效，请检查该号码对应的QQ是否已经被关闭。",other_login:"帐号登录",h_pt_login:"帐号密码登录",otherqq_login:"QQ帐号密码登录"};pt.ptui={s_url:"http\x3A\x2F\x2Fqzs.qq.com\x2Fqzone\x2Fv5\x2Floginsucc.html\x3Fpara\x3Dizone",proxy_url:"http\x3A\x2F\x2Fqzs.qq.com\x2Fqzone\x2Fv6\x2Fportal\x2Fproxy.html",jumpname:encodeURIComponent(""),mibao_css:encodeURIComponent(""),defaultUin:"",lockuin:parseInt("0"),href:"http\x3A\x2F\x2Fxui.ptlogin2.qq.com\x2Fcgi-bin\x2Fxlogin\x3Fproxy_url\x3Dhttp\x253A\x2F\x2Fqzs.qq.com\x2Fqzone\x2Fv6\x2Fportal\x2Fproxy.html\x26daid\x3D5\x26pt_qzone_sig\x3D1\x26hide_title_bar\x3D1\x26low_login\x3D0\x26qlogin_auto_login\x3D1\x26no_verifyimg\x3D1\x26link_target\x3Dblank\x26appid\x3D549000912\x26style\x3D22\x26target\x3Dself\x26s_url\x3Dhttp\x253A\x2F\x2Fqzs.qq.com\x2Fqzone\x2Fv5\x2Floginsucc.html\x3Fpara\x3Dizone\x26pt_qr_app\x3D手机QQ空间\x26pt_qr_link\x3Dhttp\x253A\x2F\x2Fz.qzone.com\x2Fdownload.html\x26self_regurl\x3Dhttp\x253A\x2F\x2Fqzs.qq.com\x2Fqzone\x2Fv6\x2Freg\x2Findex.html\x26pt_qr_help_link\x3Dhttp\x253A\x2F\x2Fz.qzone.com\x2Fdownload.html",login_sig:"",clientip:"",serverip:"",version:"201203081004",ptui_version:encodeURIComponent("10122"),isHttps:false,cssPath:"http://imgcache.qq.com/ptlogin/v4/style/32",domain:encodeURIComponent("qq.com"),fromStyle:parseInt(""),pt_3rd_aid:encodeURIComponent("0"),appid:encodeURIComponent("549000912"),lang:encodeURIComponent("2052"),style:encodeURIComponent("32"),low_login:encodeURIComponent("0"),daid:encodeURIComponent("5"),regmaster:encodeURIComponent(""),enable_qlogin:"1",noAuth:"0",target:(isNaN(parseInt("0"))?{_top:1,_self:0,_parent:2}["0"]:parseInt("0")),csimc:encodeURIComponent("0"),csnum:encodeURIComponent("0"),authid:encodeURIComponent("0"),auth_mode:encodeURIComponent("0"),pt_qzone_sig:"1",pt_light:"0",pt_vcode_v1:"1",pt_ver_md5:"000D38DC7A4DFFD0B33FFD89A00A52926C9E9CDE2207928DAA66F889",gzipEnable:"1"};</script>
...
.uncheck {
	background:
		url(http://imgcache.qq.com/ptlogin/v4/style/33/images/icon_3_tiny.png)
		no-repeat -74px -163px;
	_background:
		url(http://imgcache.qq.com/ptlogin/v4/style/33/images/icon_3_8.png)
		no-repeat -74px -163px
}
...
.qlogin .qr_0 .qr_short_tips,.qlogin .qr_0 .qr_safe_login {
	display: none
}
...
.qlogin .qr_0 .qr_info_link {
	background:
		url(http://imgcache.qq.com/ptlogin/v4/style/33/images/icon_3_tiny.png)
		no-repeat scroll 0 -541px transparent;
	_background:
		url(http://imgcache.qq.com/ptlogin/v4/style/33/images/icon_3_8.png)
		no-repeat 0 -541px;
	color: #808080;
...
.qr_tips .qr_tips_pic_chs,.qr_tips .qr_tips_pic_cht,.qr_tips .qr_tips_pic_en
	{
	background:
		url(http://imgcache.qq.com/ptlogin/v4/style/20/images/shouQ_v2/small_24_tiny.png)
		no-repeat 0 0;
	background:
		url(http://imgcache.qq.com/ptlogin/v4/style/20/images/shouQ_v2/small_8.png)
		no-repeat 0 0\9
}
...
.header .logo,.authHeader .logo {
	background:
		url(http://imgcache.qq.com/ptlogin/v4/style/11/images/icon_24_c_3.png)
		no-repeat;;
	...
	<div class="login" id="login">
		<div id="header" class="header">
			<div class="switch" id="switch">
				<a class="switch_btn_focus" hidefocus="true" id="switcher_qlogin"
					href="javascript:void(0);" tabindex="7">快速登录</a> <a
					class="switch_btn" hidefocus="true" id="switcher_plogin"
		...
		<div class="loginTips">
			...
			<div class="loading_tips" id="loading_tips">
				<span id="loading_wording">登录中</span> <img id="loading_img"
					place_src="http://imgcache.qq.com/ptlogin/v4/style/0/images/load.gif"
					align="absmiddle">
			</div>
		</div>
		<div class="qlogin" id="qlogin">
			<div class="qlogin_tips" id="qlogin_tips">
				请用<a class="qr_short_tips"
					href="http://im.qq.com/mobileqq/#from=login" target="_blank">QQ手机版</a>扫描二维码，或点击头像登录
			</div>
			...
			<div class="qlogin_show" id="qlogin_show">
				<div class="qlogin_list" id="qlogin_list">
					<span id="qr_area"><span class="qr_safe_tips">安全登录，防止被盗</span>
						<img id="qrlogin_img" alt="" class="qrImg"> <span
						class="qr_app_name"><span class="qr_safe_login">安全登录</span>
							<a hidefocus="true" draggable="false" class="qr_info_link"
							href="http://im.qq.com/mobileqq/#from=login" target="_blank">使用QQ手机版扫描二维码</a></span>
						<span class="qrlogin_img_out" onmouseover="pt.plogin.showQrTips()"
						...
						class="qr_invalid" onclick="pt.plogin.begin_qrlogin()"><span
							...
							id="qr_invalid_tips" class="qr_invalid_tips">二维码失效<br>请点击刷新
						</span></span></span>
				</div>
			</div>
				...
				<div class="web_login" id="web_login">
					<div class="tips" id="tips">
						<noscript id="noscript_area">
							<span class="noscript"> 您的浏览器脚本被禁用了， <a
						...
						<div class="operate_tips" id="operate_tips">
							<span class="operate_content">手机号码也可登录哦， <a
								class="tips_link" id="bind_account" href="javascript:void(0);">登录个人中心绑定</a></span>
							<span class="down_row"></span>
						</div>
					</div>
					<div class="login_form">
						<form id="loginform" autocomplete="off" name="loginform" action=""
							method="post" target="_self" style="margin:0">
					...
					<div class="bottom" id="bottom_web">
						...
						<a href="http://qzs.qq.com/qzone/v6/reg/index.html" class="link"
		...
		<div class="bottom hide" id="bottom_qlogin">
			<a href="javascript:void(0);" class="link vip_link" id="vip_link2"
				target="_blank">开通QQ会员</a> <span class="dotted" id="vip_dot">|</span>
			<a href="http://qzs.qq.com/qzone/v6/reg/index.html" class="link"
				target="_blank">注册新帐号</a> <span class="dotted">|</span> <a
		...
		<div id="authLogin" class="authLogin">
			...
			<div class="bottom">
				<a class="link feedback_authLogin" id="feedback_authLogin"
					href="http://support.qq.com/write.shtml?guest=1&fid=713&SSTAG=hailunna"
					target="_blank">意见反馈</a>
			</div>
		</div>
